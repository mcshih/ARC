...
from module.transformation import TPS_SpatialTransformerNetwork_same
...
def train(opt):
    ...
    if opt.stn:
        STN_net = TPS_SpatialTransformerNetwork_same(F=opt.stn_f,
...
def test(opt):
    ...
    for X_val, Y_val in tqdm(test_loader):
        ...
        save_image(X_val[0,1], 'img_2.png')
